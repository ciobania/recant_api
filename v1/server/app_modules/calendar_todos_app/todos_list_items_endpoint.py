...
from flask_jwt_auth.v1.server.models import TodosListItem, TodosList


class TodoListItemEndpoint(MethodView):
    @login_required
    ...
    def post(self, todo_list_id):
        ...
        if todo_list_id:
            todo_list = TodosList.query.filter_by(id=todo_list_id)[0]
            if not todo_list:
                response_object = {'status': 'fail',
            ...
            new_list_item = TodosListItem(**list_item, todo_list_id=todo_list_id, user=g.user).as_dict()
